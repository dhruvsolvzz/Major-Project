          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-3 justify-center">
              <button
                ...
                className={`px-6 py-2 rounded-full font-semibold transition ${filter === 'all'
              ...
              {bloodGroups.map((bg) => (
                <button
                  ...
                  className={`px-6 py-2 rounded-full font-semibold transition ${filter === bg
                    ? 'bg-gradient-to-r from-red-500 to-pink-600 text-white shadow-lg'
                    : 'bg-white text-gray-700 hover:bg-red-50'
                    }`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredNeeders.map((needer, index) => (
                ...
                >
                  ...
                  <div
                    className={`mb-4 px-4 py-2 rounded-lg font-semibold text-center shadow-md ${needer.urgency === 'Critical' ? 'bg-gradient-to-r from-red-600 to-red-700 text-white' :
